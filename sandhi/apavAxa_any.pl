...
if($an=~/(.*)a\+(o[mzfFnN].*)/){$ans = "$1$2";$ans1="pararUpa";$ans2="omAfoSca(6.1.95)";}
...
if($an =~ /(.*)[aA]\+e(wi|Ri|mi|wA|wArO|wAraH|wAsi|wAsWaH|wAsWa|wAsmi|wAsvaH|wAsmaH|Ryawi|RyawaH|Ryanwi|Ryasi|RyaWaH|RyaWa|RyAmi|RyAvaH|RyAmaH|wu)$/){$ans="$1E$2";$ans1="vqxXi";$ans2="ewyeXawyUTsu (6.1.86)";}
if($an =~ /(.*)[aA]\+E(w|wAm|H|wam|wa|va|ma|Ryaw|RyawAm|Ryan|RyaH|Ryawam|Ryawa|Ryam|RyAva|RyAma)$/){$ans="$1E$2";$ans1="vqxXi";$ans2="ewyeXawyUTsu (6.1.86)";}
if($an =~ /(.*)[aA]\+[eE]X(.*)/){$ans="$1EX$2";$ans1="vqxXi";$ans2="ewyeXawyUTsu (6.1.86)";}
if($an =~ /(.*)[aA]\+Uha(.*)/){$ans="$1Oha$2";$ans1="vqxXi";$ans2="ewyeXawyUTsu (6.1.86)";}
