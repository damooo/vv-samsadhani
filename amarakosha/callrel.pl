...
$pid = $ARGV[4];
      ...
      if($relation eq "tree"){
         system ("mkdir -p TFPATH/AMARA_DOT");
         system("$myPATH/amarakosha/get_all_rel.pl $word_wx $out_encoding | GraphvizDot/dot -Tjpg -o TFPATH/AMARA_DOT/graph$pid.jpg");
         print"<center><img src=\"SCLURL/amarakosha/DOT/graph$pid.jpg\" \/></center><br>";
      }else {
