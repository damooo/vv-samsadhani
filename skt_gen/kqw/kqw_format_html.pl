...
print "<a href=\"javascript:generate_noun_forms('Unicode','$m','पुं','2')\">$m</a></td>";
print "</td><td width=20% align=\"center\" bgcolor='#E6CCFF'><font color=\"black\" size=\"4\">\n";
print "<a href=\"javascript:generate_noun_forms('Unicode','$f','स्त्री','2')\">$f</a>";

print "<td width=20% align=\"center\" bgcolor='#E6CCFF'><font color=\"black\" size=\"4\">\n";
print "<a href=\"javascript:generate_noun_forms('Unicode','$n','नपुं','2')\">$n</a></td></tr>\n";
}else{
