...
;
value multiple_relations_begin = 23 (* inclusive *)
;
...
&& not (r1=2) && not(r2=2) then False (* do { print_string "C5"; False} *)
         ...
         then False
                ...
                && (r1=32||r2=16) && r2=33 (* a RaRTI of a viSeRaNa/kriyAviSeRaNa is not allowed *)
         then False
         else if from_id1=to_id2 && from_mid1=to_mid2
                && (r2=32||r2=16) && r1=33 (* a RaRTI of a viSeRaNa/kriyAviSeRaNa is not allowed *)
         then False
